...
public class testSignificantMovements {
	...
	public static void main(String[] args) {
		...
		try {
			...
			ArrayList<HashMap<String,String>> significantMovements = new ArrayList<HashMap<String,String>>();
			int counter = 0;
			while (highVolDates.hasNextLine() && counter<2){
				line = highVolDates.nextLine().split(",");
				significantMovements = openRefinedMovementFile(line[0], line[1], significantMovements);
				counter++;
			}
	...
	public static ArrayList<HashMap<String,String>> openRefinedMovementFile(String date, String instrument, ArrayList<HashMap<String,String>> significantMovements){
		try{
